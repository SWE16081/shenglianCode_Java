...
/**
 * @author Lyy
 * #date 2019/05/03 8:31
 */
public class AdminTransactionRecordAllVO {
    @NotNull(message = "序号不允许空")
    ...
    @NotEmpty(message = "学生姓名不允许空")
    private String name;
    @NotNull(message = "出生日期不允许空")
    @JsonFormat(pattern = "yyyy-MM-dd", timezone = "GMT+8")
    private Date birthday;
    @NotNull(message = "是否逾期不允许空")
